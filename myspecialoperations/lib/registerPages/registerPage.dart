...
class RegisterFirstPage extends StatefulWidget {
  ...
  RegisterFirstPage({Key key, this.photoPath}) : super(key: key);

  _RegisterFirstPageState createState() =>
      _RegisterFirstPageState(photoPath: this.photoPath);
}
...
class _RegisterFirstPageState extends State<RegisterFirstPage> {
  String photoPath;
  _RegisterFirstPageState({photoPath}) {
  ...
  static const platform = const MethodChannel('samples.flutter.dev/myspecialoperations');
  String sex;
         ...
         Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 2.0),top: BorderSide(width: 2.0),right: BorderSide(width: 1.0))),
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 1.0),top: BorderSide(width: 2.0),right: BorderSide(width: 1.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image2 == null
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 1.0),top: BorderSide(width: 2.0),right: BorderSide(width: 2.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image3 == null
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 1.0),left: BorderSide(width: 2.0),right: BorderSide(width: 1.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 1.0),left: BorderSide(width: 1.0),right: BorderSide(width: 1.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 1.0),left: BorderSide(width: 1.0),right: BorderSide(width: 2.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 2.0),top: BorderSide(width: 1.0),right: BorderSide(width: 1.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image4 == null
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 1.0),top: BorderSide(width: 1.0),right: BorderSide(width: 1.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image5 == null
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(left: BorderSide(width: 1.0),top: BorderSide(width: 1.0),right: BorderSide(width: 2.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image6 == null
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),left: BorderSide(width: 2.0),right: BorderSide(width: 1.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image7 == null
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),left: BorderSide(width: 1.0),right: BorderSide(width: 1.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image8 == null
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),left: BorderSide(width: 1.0),right: BorderSide(width: 2.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 150,
                  width: 110,
                  child: _image9 == null
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 2.0),left: BorderSide(width: 2.0),right: BorderSide(width: 1.0))),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 2.0),left: BorderSide(width: 1.0),right: BorderSide(width: 1.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
                ...
                Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(border: Border(top: BorderSide(width: 1.0),bottom: BorderSide(width: 2.0),left: BorderSide(width: 1.0),right: BorderSide(width: 2.0)),),
                  padding: EdgeInsets.only(right: 8),
                  height: 50,
                  width: 110,
                  child: RaisedButton(
  ...
  <soapenv:Body> 
    <q0:insertTzzyInfo>'''+
  "<arg0>"+data['username']+"</arg0>"+
  "<arg1>"+data['psd']+"</arg1>"+
  "<arg2>"+data['ryxm']+"</arg2>"+
  "<arg3>"+data['sex']+"</arg3>"+
  "<arg4>"+data['sfzlj']+"</arg4>"+
  "<arg5>"+""+"</arg5>"+
  "<arg6>"+data['phone']+"</arg6>"+
  "<arg7>"+""+"</arg7>"+
  "<arg8>"+""+"</arg8>"+
  "<arg9>"+""+"</arg9>"+
  "<arg10>"+""+"</arg10>"+
